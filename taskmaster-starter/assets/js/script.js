...
var auditTask = function(taskEl){
  ...
  //apply new clas if item near/over due date
...
$(".list-group").on("change", "input[type='text']", function() {
  ...
  //get the parent's ul id attribut
  var status = $(this)
    .closest(".list-group")  
    .attr("id")
    .replace("list-", "");
  ...
  //update task in array in re-save in local storage
  tasks[status][index].date = date;
  saveTasks()  ;

  //recreate span elemtnts with Bootstrap classes
  var taskSpan = $("<span>")
